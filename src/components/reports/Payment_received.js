  ...
  const getPayRec = async () => {
    ...
    try {
      const respone = await axios.get(
        `http://knowforth.online:8003/api/GetPayRec/${compId}/${custId}?startDate=${dateFrom}&endDate=${dateTill}`,
        {
          auth: {
            username: userName,
            password: passWord,
  ...
  const downloadPdf = () => {
    ...
    setTimeout(() => {
      ...
      html2canvas(input).then((canvas) => {
        ...
        pdf.save(`PayRec_${currentyear}${currentMonth}${currenDate}${hour}${minute}.pdf`);
      });
    ...
    <div>
      <div className="card-body">
        <div className="row ">
          ...
          <div className="col-lg-12 col-12 col-sm-6 col-md-6 d-flex justify-content-end my-2">
            <button
              type="button"
              onClick={getPayRec}
            ...
            <div className="dropdown mx-2">
              ...
              >
                ...
                <TableToExcel
                  ...
                  filename={`PayRec_${currentyear}${currentMonth}${currenDate}${hour}${minute}`}
                  sheet="sheet 1"
...
export default Payment_received;
